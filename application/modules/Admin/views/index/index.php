...
<body class="fixed-sidebar full-height-layout gray-bg">
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-cutlery"></i> <span class="nav-label">管理 </span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="/admin/node/index">节点管理</a>
                            </li>
                        </ul>
                    </li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="/admin/index/welcome" frameborder="0" data-id="/admin/index/welcome" seamless></iframe>
            </div>
            <div class="footer">
    ...
    <!-- 自定义js -->
    <script src="/public/admin/js/hplus.min.js?v=3.0.0"></script>
